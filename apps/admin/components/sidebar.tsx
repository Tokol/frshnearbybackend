...
export function Sidebar() {
  ...
  return <aside className="sidebar">
    ...
    <nav><Link className={pathname === '/' ? 'active' : ''} href="/">Overview</Link><Link className={pathname.startsWith('/users') ? 'active' : ''} href="/users">People & businesses</Link><Link className={pathname.startsWith('/verifications') ? 'active' : ''} href="/verifications">Verification queue</Link><Link className={pathname.startsWith('/reko-rings') ? 'active' : ''} href="/reko-rings">REKO rings</Link><Link className={pathname.startsWith('/admins') ? 'active' : ''} href="/admins">Admin management</Link></nav>
